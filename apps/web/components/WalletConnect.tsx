...
export function WalletConnect() {
  ...
  return (
    <div className="bg-zinc-900 p-4 md:p-6 rounded-xl border border-zinc-800 shadow-xl max-w-sm w-full font-sans">
      <div className="flex flex-col space-y-6">
        ...
        <div className="flex flex-col space-y-4">
          {!address ? (
            ...
            <div className="flex flex-col space-y-4">
              <div className="p-4 bg-zinc-800/50 border border-zinc-700/50 rounded-xl flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-indigo-500 shrink-0 mt-0.5" />
                <div className="flex flex-col">
                  <span className="text-xs text-zinc-400 font-medium mb-1">Connected Address</span>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 font-medium py-3 px-4 rounded-xl transition-all duration-200 border border-zinc-700 hover:border-zinc-600 focus:outline-none focus:ring-2 focus:ring-zinc-600"
              >
